...
public class Empleado {
	...
	/**
	 * Si eres el empleado con el hash numero 1, puedes utilizar este método. Dar de
	 * alta un empleado en la lista * de empleados
	 * 
	...
	/**
	 * Si eres el empleado con el hash numero 1, puedes utilizar este método. Metodo
	 * para dar de alta un producto
	 * 
	 * @param nombre : nombre del producto
	 * @param precio : precio del producto
	 * @param tipo   : perecedero o imperecedero
	 * @return b : true si se puede dar de alta el producto y false si no (producto
	 *         no valido o empleado sin permisos)
	 */
	...
	/**
	 * Si eres el empleado con el hash numero 1, puedes utilizar este método.
	 * Muestra una lista de los cajeros y el total de dinero de sus ventas
	 */
	...
	/**
	 * Si eres el empleado con el hash numero 1, puedes utilizar este metodo que da
	 * de baja un producto
	 * 
