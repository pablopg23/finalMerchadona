...
public class Cajero extends Empleado {
	...
	// Atributos
	/**
	 * Atributos: String nombre e int hash (de la clase Empleado) y float
	 * total_ventas que almacenará el precio total de productos vendidos
	 */
	 ...
	 * @param hash   : numero del cajero total_ventas se inicializa en 0.
	 */
