...
/**
 * Los productos a vender tienen un nombre, un precio base, y una cantidad en
 * stock, Los tenemos de dos tipos perecederos e imperecederos.
 * 
 * @author Jorge y Javi
 * @version 05/2019
 * @since 05/16/2019
...
public class Producto {
	 ...
	 * 
	 * @param cantidad : cantidad de producto que se suma a la cantidad que habia
	 *                 antes de aniadir
	 */
	...
	/**
	 * Metodo que actualiza la cantidad de producto, restando el numero que se
	 * retire
	 * 
	 * @param cantidad : cantidad de producto que se resta a la cantidad que habia
	 *                 antes de retirar
	 */
